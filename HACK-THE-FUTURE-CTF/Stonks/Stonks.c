...
void buyUwus() {
    puts("How many Stonks do you want to buy?");

    int num;
    scanf(" %d", &num);

    if (num < 0) {
        puts("Be Smart now ,You can't buy negative Stonks  >:(");
        return;
    }
    ...
    printf("You bought %d Meme Stonks\n", num);
}
